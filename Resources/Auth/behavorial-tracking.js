...
function addEventlisteners() {
    ...
    document.getElementById("address").addEventListener("keydown", countKeyPresses);
    document.getElementById("zipcode").addEventListener("keydown", countKeyPresses);
    ...
    document.getElementById("address").addEventListener("keypress", countCharactersTyped);
    document.getElementById("zipcode").addEventListener("keypress", countCharactersTyped);
